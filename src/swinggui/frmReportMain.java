 ...
 * @author HAKHENG
 */
public class frmReportMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuUserManagement.setText("Export Report");
        ...
        menuGroupManagement.setText("Print Report");
        ...
        menuSupplier3.setText("Customer Report");
        menuSupplier3.setPreferredSize(new java.awt.Dimension(160, 40));
        menuSupplier3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuSupplier3ActionPerformed(evt);
            }
        });
        jMenu5.add(menuSupplier3);

        jMenuBar1.add(jMenu5);

        jMenu2.setText("Date_Range _Menu");
        jMenu2.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jMenu2.setMaximumSize(new java.awt.Dimension(150, 32767));
        jMenu2.setMinimumSize(new java.awt.Dimension(80, 35));
        jMenu2.setPreferredSize(new java.awt.Dimension(135, 35));

        menuCustomer.setText("Today's Report");
        menuCustomer.setPreferredSize(new java.awt.Dimension(145, 40));
        jMenu2.add(menuCustomer);

        menuSupplier.setText("Weekly Report");
        ...
        menuSupplier1.setText("Monthly Report");
        ...
        menuSupplier4.setText("Custom Range");
        menuSupplier4.setPreferredSize(new java.awt.Dimension(145, 40));
        menuSupplier4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuSupplier4ActionPerformed(evt);
            }
        });
        jMenu2.add(menuSupplier4);
    ...
    private void menuSupplier3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuSupplier3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_menuSupplier3ActionPerformed

    private void menuSupplier4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuSupplier4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_menuSupplier4ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReportMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReportMain().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenuItem menuSupplier3;
    private javax.swing.JMenuItem menuSupplier4;
